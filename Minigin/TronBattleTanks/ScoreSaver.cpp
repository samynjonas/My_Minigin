...
dae::ScoreSaver::ScoreSaver(const std::string& scoreFile)
	: m_ScoreFile{ scoreFile }
{

}

void dae::ScoreSaver::AddScore(int score, const std::string& playerName)
{
...
std::vector<dae::playerScoreInfo> dae::ScoreSaver::GetHighScores() const
{
